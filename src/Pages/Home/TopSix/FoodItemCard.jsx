  ...
  return (
    <div>
      <Link to={`/allfoodItems/${_id}`}>
        {" "}
        <div className=" max-w-sm cursor-pointer transition transform hover:scale-105 duration-300  mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
          <motion.img
