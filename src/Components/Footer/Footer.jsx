          ...
          <div className="lg:flex">
            <div className="w-full lg:-mx-6 lg:w-2/5 ">
              <div className="lg:px-6 text-center lg:text-left">
                ...
                <p className="lg:max-w-sm max-w-ful  mt-2 text-gray-500 dark:text-gray-400 ">
                  Join 1,000 branches all over Middle East
                </p>

                <div className=" mt-6 lg:-mx-2 flex justify-center gap-2 lg:justify-start">
                  <a
                    href="#"
